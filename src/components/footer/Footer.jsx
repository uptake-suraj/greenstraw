        ...
        <div className="bg-white shadow-lg rounded-3xl p-6 md:p-10">
          <div className="flex flex-col lg:flex-row justify-between gap-8">
            ...
            <div>
              ...
              <ul className="text-gray-700 text-lg space-y-1">
                ...
                <li>
                  <Link to="/tgs-school-project">TGS School Project</Link>
                </li>
                <li>
                  <Link to="/odkhaan">Odkhaan</Link>
                </li>
                <li>
                  <Link to="/greenstraw-house">The Greenstraw House</Link>
                </li>
                <li>
                  <Link to="/events-workshops">Events & Workshops</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-gray-700 text-lg space-y-1">
                ...
                <li>
                  <Link to="/data-tracking">Data Tracking</Link>
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col text-lg sm:flex-row justify-between items-center mt-8 pt-4 border-t border-gray-200 text-gray-500 gap-2">
            ...
            <p className="flex items-center">
              Powered by
              <Link
                to="https://uptakeinfotech.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center"
              >
                <img
                  src={Images.uptakeLogo}
                  alt="uptake infotech"
                  className="h-10 w-12 object-contain mb-3 "
                />
              </Link>
            </p>
          </div>
